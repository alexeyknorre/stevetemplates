...
Office: $if(office)$$office$$else$TBD$endif$  & Class Room: $if(classroom)$$classroom$$else$TBD$endif$\\
	&  \\
Teaching Assistant: Bressia Borja \\
E-mail: $if(email2)$\texttt{$email2$}$else$TBD$endif$ \\
Office Hours: $if(officehours2)$$officehours2$$else$TBD$endif$ \\
Office: $if(office2)$$office2$$else$TBD$endif$\\
	&  \\
...
Office Hours: $if(officehours)$$officehours$$else$TBD$endif$  &  Class Hours: $if(classhours)$$classhours$$else$TBD$endif$\\
Office: $if(office)$$office$$else$TBD$endif$  & Class Room: $if(classroom)$$classroom$$else$TBD$endif$\\
Syllabus Revision: $if(syllabus_revision)$$syllabus_revision$$else$V1$endif$ & Class Canvas: $if(class_canvas)$\href{https://$class_canvas$}{\tt here}$else$TBD$endif$\\
	&  \\
